...
public class CreatePaidBillBean {
     ...
     * Submit form
     * 
     * @return if has error throw error massage, other way - true.
     */
	 ...
	 */
	if (paidBillService.checkBillExist(paidBillModel.getUser().getId(), paidBillModel.getMonth(),
	 ...
	 */
	if (unPaidBillService.checkBillExist(paidBillModel.getUser().getId(), paidBillModel.getMonth(),
		paidBillModel.getYear()) != null) {
