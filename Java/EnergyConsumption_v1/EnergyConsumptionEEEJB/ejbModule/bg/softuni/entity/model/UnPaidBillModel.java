...
@Entity
@Table(name = "UNPAID_BILLS")
public class UnPaidBillModel extends BaseDomainObject {
	...
	public UnPaidBillModel() {
	}

	public UnPaidBillModel(Long id, Long month, Long year, Float sumWithoutTax, Float sumWithTax) {
		this.id = id;
		this.month = month;
		this.year = year;
