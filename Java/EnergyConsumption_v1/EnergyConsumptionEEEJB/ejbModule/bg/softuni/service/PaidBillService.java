 ...
 */
@Stateless
public class PaidBillService implements BaseBillLocal<PaidBillModel> {
    ...
    @Override
    public List<PaidBillModel> findAllBills(Long id) {
    ...
    @Override
    public PaidBillModel checkBillExist(Long uId, Long month, Long year) {
